...
export function LandingWork() {
  ...
  return (
    <section ref={rootRef} id="work" className="py-16 md:py-24 lg:py-28">
      <div className="mx-auto w-[calc(100%_-_48px)] max-w-[1216px]">
        ...
        <div data-work-steps="true" className="space-y-px bg-[#e5e5e5]">
          {STEPS.map((s) => (
            <div data-work-step="true" key={s.num} className="grid grid-cols-12 gap-4 bg-white p-6 transition-colors md:gap-6 md:p-10 md:hover:bg-[#fafafa]">
              ...
              <div className="col-span-12 text-base leading-relaxed text-[#4B5563] md:col-span-8">{s.desc}</div>
            </div>
          ))}
        </div>
        </div>
